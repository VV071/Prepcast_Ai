      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <div className="space-y-3">
          ...
          <button 
            onClick={onExportRaw}
            disabled={!canExport}
            className={`w-full text-left p-3 rounded-lg transition-colors flex items-center group ${
              canExport ? 'bg-slate-50 hover:bg-slate-100' : 'bg-slate-50 opacity-50 cursor-not-allowed'
            }`}
          >
          ...
          <button 
            ...
            className={`w-full text-left p-3 rounded-lg transition-colors flex items-center group ${
                canExportProcessed ? 'bg-slate-50 hover:bg-slate-100' : 'bg-slate-50 opacity-50 cursor-not-allowed'
            }`}
          >
